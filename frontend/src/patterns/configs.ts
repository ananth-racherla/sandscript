...
export const PATTERN_CONFIGS: PatternConfig[] = [
  ...
  },
  {
    ...
    params: [
      ...
      { kind: 'checkbox', key: 'flipHorizontal', label: 'Flip left / right', default: false },
      { kind: 'checkbox', key: 'flipVertical', label: 'Flip top / bottom', default: false, hint: 'The correct orientation is already the default (SVGs are authored top-down; the table is bottom-up) — this flips it again, e.g. to mirror a design intentionally' },
    ],
  },
];
